...
class Comm : protected Pointers {
 public:
  ...
  virtual void forward_comm_tensor(int, std::unordered_map<int, int>, torch::Tensor&, int)=0; // xjf: forward comm of tensor
  virtual void forward_comm_tensor_reduce(int, std::unordered_map<int, int>, torch::Tensor&, int)=0; // xjf: forward comm of tensor
