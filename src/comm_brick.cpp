...
#include <iostream>//xjf
#include <fstream>//xjf
#include <unistd.h>//xjf
...
------------------------------------------------------------------------- */
void CommBrick::forward_comm_tensor(int nsize, std::unordered_map<int, int> atom_map, torch::Tensor& mytensor, int syncflag){}
void CommBrick::forward_comm_tensor_reduce(int nsize, std::unordered_map<int, int> atom_map, torch::Tensor& mytensor, int syncflag){}
