...
class CommTiled : public Comm {
 public:
  ...
  virtual void forward_comm_tensor(int,std::unordered_map<int, int>, torch::Tensor&, int); // xjf: forward comm of tensor
  virtual void forward_comm_tensor_reduce(int,std::unordered_map<int, int>, torch::Tensor&, int); // xjf: forward comm of tensor
