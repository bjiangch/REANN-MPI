...
------------------------------------------------------------------------- */
void CommTiled::forward_comm_tensor(int nsize, std::unordered_map<int, int> atom_map, torch::Tensor& mytensor, int syncflag){}
void CommTiled::forward_comm_tensor_reduce(int nsize, std::unordered_map<int, int> atom_map, torch::Tensor& mytensor, int syncflag){}
